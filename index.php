<?php get_header(); ?>
	...
	<section id="rezume" class="s_rezume">
		<div class="section_header">
			<h2><?php
			$idObj = get_category_by_slug('s_rezume');
			$id = $idObj->term_id;
			echo get_cat_name($id);
			?></h2>
			<div class="s_descr_wrap">
				...
				<div class="row">
					<div class="resume_container">
						<div class="col-md-6 col-sm-6 left">
							...
							<div class="resume_icon"><i class="icon-basic-case"></i></div>
								...
								<div class="resume_item">
									...
									<div class="year"><?php echo get_post_meta($post->ID, 'rezume_years', true); ?></div>
									<div class="resume_description"><?php echo get_post_meta($post->ID, 'rezume_place', true); ?><strong><?php the_title(); ?></strong></div>
									<?php the_content(); ?>
								</div>
						...
						<div class="col-md-6 col-sm-6 right">
							...
							<div class="resume_item">
								<div class="year"><?php echo get_post_meta($post->ID, 'rezume_years', true); ?></div>
								<div class="resume_description"><strong><?php the_title(); ?> </strong><?php echo get_post_meta($post->ID, 'rezume_place', true); ?></div>
								<?php the_content(); ?>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="filter_div controls">
						<ul>
							<li class="filter active" data-filter="all">Всі работи</li>
							<li class="filter" data-filter=".sites">Сайти</li>
							<li class="filter" data-filter=".identy">Айдентика</li>
							<li class="filter" data-filter=".logos">Логотипи</li>
						</ul>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						...
						<div class="contact_box">
							...
							<p><a href="//<?php 
							$options = get_option('sample_theme_options');
							echo $options['web_text']; ?>" target="_blank"><?php 
							$options = get_option('sample_theme_options');
							echo $options['web_text']; ?></a></p>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<form action="http://formspree.io/rostyslaw@mail.ua" class="main_form" novalidate target="_blank" method="post">
